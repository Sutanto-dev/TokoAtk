<%-- 
    ...
    Created on : 19 Jun 2025, 14.13.01
...
<head>
    <meta charset="UTF-8">
    <title>Sales Detail - Tambah Item</title>
...
<div class="container">
        ...
        <div class="header">
            <div>
                <h1>Tambah Item ke Transaksi Sales</h1>
                <p><strong>Sales Code:</strong> ${sales.getId()}</p>
            </div>
        </div>

        <div class="card" style="margin-top: 2em;">
            <div class="card-content">
                <form action="salesdetailtambah.jsp" method="post" onsubmit="return validateForm()" style="max-width: 500px;">
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 20px;">
                        ...
                        <a href="saleslist.jsp" class="btn btn-secondary" style="padding: 12px 20px;">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    function validateForm() {
        const barangId = document.getElementById('barangId').value.trim();
        const qty = document.getElementById('qty').value;
        const harga = document.getElementById('harga').value;
        
        if (barangId === '') {
            alert('Barang ID tidak boleh kosong!');
            return false;
        }
